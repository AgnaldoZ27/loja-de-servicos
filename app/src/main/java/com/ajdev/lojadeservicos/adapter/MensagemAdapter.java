...
public class MensagemAdapter extends RecyclerView.Adapter<MensagemAdapter.MyViewHolder> {
    ...
    private List<Usuario> mensagens;
    private Context context;


    public MensagemAdapter(List<Usuario> listaMensagens, Context c) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            foto = itemView.findViewById(R.id.imageViewMensagem);
            nome = itemView.findViewById(R.id.textNomeMensagem);
        }
    }
}
